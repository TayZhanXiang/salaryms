...
public class CommonString {
    ...
    /*
     * This class is for all the common internal string sentences available for
     * different entities usage
     */
    ...
    public static final String ERROR_MISSING_NAME = "Missing name";
